  ...
  useGSAP(() => {
    gsap.to("#exploreVideo", {
      scrollTrigger: {
        ...
        toggleActions: "play pause reverse restart", //controla como a animação vai se controlar em quatro estagios da animação
        ...
        start: "-10% bottom", //quando o target estiver com X% de visibilidade na viewport, ativa as animações
      },
      onComplete: () => {
